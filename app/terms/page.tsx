...
export const metadata: Metadata = {
  ...
  description: "Review Archita Creation's business conditions, wholesale billing contracts, shipment agreements, and design copyrights.",
};
    ...
    <>
      ...
      <section className="py-24 bg-white dark:bg-luxury-dark font-sans text-sm font-light text-luxury-dark/80 dark:text-white/80 leading-relaxed">
        <div className="max-w-3xl mx-auto px-6">
          <p className="mb-6">
            Welcome to the digital showroom of <strong>Archita Creation</strong>. By using this website, requesting digital design catalogs, or placing orders via our enquiry desks, you agree to comply with the terms and conditions outlined below.
          </p>
          ...
          <div className="border-t border-luxury-dark/10 dark:border-white/10 pt-8 mt-12 text-xs text-luxury-dark/40 dark:text-white/40">
            Last Updated: June 30, 2026. For questions regarding wholesale contracts, contact legal@architacreation.com.
          </div>
        </div>
      </section>
    </>
